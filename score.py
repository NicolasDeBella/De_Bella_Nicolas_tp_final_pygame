...
from constants import (DEBUG,HIGH_SCORE,WIDTH_SOCRE)

class Score(pygame.sprite.Sprite):
    def __init__(self,pos_x,pos_y):
        super().__init__()
        self.__score = Auxiliar.getSurfaceFromSpriteSheet(r"assets\graphics\score\score.png",13,1,HIGH_SCORE,WIDTH_SOCRE)
        self.__frame = 0
        self.__animation = self.__score
